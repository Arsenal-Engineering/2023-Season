...
public class LimelightCam extends SubsystemBase {
  //creates a camera object, requires a camera with photonvision firmware installed
  ...
  public Translation2d getTranslation(){
    ...
    if(latestResult.hasTargets()){
      ...
      Translation2d translation = PhotonUtils.estimateCameraToTargetTranslation(distance, Rotation2d.fromDegrees(-latestResult.getBestTarget().getYaw()));
      return translation;
    }
    return null;
  }
